...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        cb.setOAuthConsumerKey("6nrytOWcfGnNoZDxxb1W4khFc")
                .setOAuthConsumerSecret("9jiS2VkgiWF1AmHZCFOhgyEIIZq43rwTd59o5Uajn1lDjcRVYV")
                .setOAuthAccessToken("2465716451-bahT5gMKhLt6xQxJiFAJfQpQp68QLROJBOduaqb")
                .setOAuthAccessTokenSecret("WGiawwiuwpQxGZizI7wApSOt6rXPFaYopigR7SibupRAA");
